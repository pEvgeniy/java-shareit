...
class ItemControllerTest {
    ...
    void setUp() {
        ...
        ItemDto itemDto = ItemDto.builder()
                ...
                .build();
        createdItem = itemController.createItem(itemDto, 1).getBody();
    }
    ...
    @Test
    void createItem() {
        ItemDto foundItem = itemController.findById(createdItem.getId(), 1).getBody();
    ...
    @Test
    void findAll() {
        List<ItemDto> foundItems = itemController.findAll(1, 0, 20).getBody();
    ...
    @Test
    void findById() {
        ItemDto foundItem = itemController.findById(1, 1).getBody();
        assertItemDtoFields(foundItem);
    }
    ...
    void updateName() {
        ...
        ItemDto updatedItem = itemController.update(1, createdItem, 1).getBody();
    ...
    @Test
    void search() {
        List<ItemDto> foundItems = itemController.search("name", 1, 10).getBody();
    ...
    void searchWhenTextIsBlank() {
        List<ItemDto> foundItems = itemController.search("  ", 1, 10).getBody();
        assertEquals(0, foundItems.size());
    }

    @Test
    void searchWhenTextIsNull() {
        List<ItemDto> foundItems = itemController.search(null, 1, 10).getBody();
        assertEquals(0, foundItems.size());
    }
