...
class UserControllerTest {
    ...
    void setUp() {
        UserDto userDto = UserDto.builder()
                ...
                .email("user@mail.com")
                .build();
        createdUser = userController.create(userDto).getBody();
    }

    @Test
    void create() {
        UserDto foundUser = userController.findById(createdUser.getId()).getBody();
    ...
    @Test
    void findAll() {
        List<UserDto> foundUsers = userController.findAll().getBody();
